...
<div class="flex flex-col w-[15%] h-screen bg-white justify-between">
    <div>
        <ul id="ull" class=" mt-3 text-[#9F9E9E] text-xl font-Almarai">

            <li class="bg-white active:bg-[#F5F0EA] border-[#BF9874] active:border-r-4 p-2 cursor-pointer mr-3">
                <a href="" class="">
                    <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg"
                        class="inline-block w-6 h-6 mr-2 -mt2">>
                        <path
            ...
            <li class="active:bg-customBrown bg-customGray p-2 cursor-pointer mr-3 ">
                <a href="" class="">
                    <svg width="24" height="24" viewBox="0 0 20 20" fill="none"
                        xmlns="http://www.w3.org/2000/svg" class="inline-block mr-2 ">
                        <path
            ...
            <li class="active:bg-customBrown bg-customGray p-2 cursor-pointer mr-3 ">
                <a href="" class="">
                    ...
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" class="inline-block mr-2"
            ...
            <li class="active:bg-customBrown bg-customGray p-2 cursor-pointer mr-3 ">
                <a href="" class="">
                    <svg width="18" height="18" viewBox="0 0 18 18" fill="none" class="inline-block mr-2"
                        xmlns="http://www.w3.org/2000/svg">
                        <path

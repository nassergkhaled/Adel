...
<div class="flex flex-col h-screen bg-white justify-between shadow-md">
    <div>
        <ul class="  text-[#9F9E9E] font-bold text-sm font-Almarai space-y-4">
            ...
            <x-nav-link :href="route('legalCases.index')" :active="request()->routeIs('legalCases.index')" class="p-[0.60rem] flex items-center  {{ request()->routeIs('legalCases.index') ? 'text-yourActiveColor' : 'text-gray-400' }}">
